...
public class DietControllerIT extends AbstractControllerIT {
	...
	void givenValidDietRequestDto_whenGenerateDiet_thenOKStatus200_StartGenerateDiet() throws Exception {
		...
		anthropometryDto.setHeight(Double.valueOf(176));
		anthropometryDto.setWeight(Double.valueOf("68.7"));
		CircumferenceDto circumferenceDto = new CircumferenceDto();
		circumferenceDto.setArm(Double.valueOf(200));
		circumferenceDto.setChest(Double.valueOf(300));
		circumferenceDto.setChest(Double.valueOf(400));
		circumferenceDto.setThigh(Double.valueOf(324));
		circumferenceDto.setWaist(Double.valueOf(156));
		anthropometryDto.setCircumference(circumferenceDto);
		FoldDto foldDto = new FoldDto();
		foldDto.setAbdominal(Double.valueOf(167));
		foldDto.setAxillary(Double.valueOf(343));
		foldDto.setPectoral(Double.valueOf(632));
		foldDto.setSubscapolaris(Double.valueOf(422));
		foldDto.setSuprailiac(Double.valueOf(955));
		foldDto.setThigh(Double.valueOf(343));
		foldDto.setTriceps(Double.valueOf(721));
